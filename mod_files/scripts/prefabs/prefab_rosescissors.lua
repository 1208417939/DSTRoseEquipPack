...
local data_cfg = weapon_data_resolver.resolve_weapon_data("rosescissors")
if data_cfg == nil then
    error("Failed to resolve weapon data for rosescissors")
end

local weapon_factory = require("rose_core/rose_weapon_factory")
local rose_scissors_def = require("rose_defs/weapon_def_builder").build("rosescissors")
...
local function fn()
    ...
    weapon_factory.attach_runtime(inst, rose_scissors_def)
