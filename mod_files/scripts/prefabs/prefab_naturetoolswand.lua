...
local data_cfg = weapon_data_resolver.resolve_weapon_data("naturetoolswand")
if data_cfg == nil then
    error("Failed to resolve weapon data for naturetoolswand")
end

local weapon_factory = require("rose_core/rose_weapon_factory")
local naturetoolswand_def = require("rose_defs/weapon_def_builder").build("naturetoolswand")
...
local function fn()
    ...
    weapon_factory.attach_runtime(inst, naturetoolswand_def)
