    ...
    crowscythe = {
        ...
        abilities = {
            ...
            sentient_talk = {
                ...
                dusk_chance = 0.18,
                night_chance = 0.30,
                nightvision_bonus = 0.15,
                heat_bonus_multiplier = 0.25,
                jitter_range = 0.08,
                min_probability = 0.05,
                max_probability = 0.90,
                hard_cooldown = 6,
                normal_min_interval = 25,
                normal_max_interval = 50,
                hot_min_interval = 12,
                hot_max_interval = 28,
                hot_threshold = 0.35,
                recent_memory_size = 4,
                heat_decay_per_second = 0.015,
                nightvision_heat_gain = 0.35,
                nightvision_heat_gain_off = 0.10,
                kill_heat_gain = 0.25,
                kill_heat_scale = 0.01,
                kill_heat_cap = 0.35,
                kill_talk_chance = 0.45,
                kill_talk_delay_min = 0.20,
                kill_talk_delay_max = 0.60,
                reject_cooldown = 2.5,
