...
STRINGS.ROSE_EQUIP_PACK_DURABILITY_LINES.BROKEN_GENERIC = "它坏了。"
STRINGS.ROSE_EQUIP_PACK_DURABILITY_LINES.CROWSCYTHE_BROKEN_OWNER = "喂，继续工作。"
STRINGS.ROSE_EQUIP_PACK_DURABILITY_LINES.CROWSCYTHE_BROKEN_WEAPON = "我要黑暗的灵魂！"

-- water warning lines
STRINGS.ROSE_EQUIP_PACK_WATER_WARNING_LINES = STRINGS.ROSE_EQUIP_PACK_WATER_WARNING_LINES or {}
STRINGS.ROSE_EQUIP_PACK_WATER_WARNING_LINES.ROSEPARASOL_LOW_DURABILITY_5 = "或许我该找块陆地。"
STRINGS.ROSE_EQUIP_PACK_WATER_WARNING_LINES.ROSEPARASOL_LOW_DURABILITY_1 = "要沉了！"
